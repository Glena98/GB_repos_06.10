...
Чтобы перейти к другой ветке, нужно воспользоваться функцией git checkout branch_name.

## Как работать с удалённым репозиторием GitHub:
...
5. Проверить изменения с другого компьютера (или с GitHub).
6. Скачать (pull) актуальные состояния тз удалённого репозитория.
